...
Dòng thông báo xuất hiện trong Console là:

Hello from JavaScript!

> - Điều này cho em biết JavaScript đang làm gì khi trang web được tải?
Khi trang HTML được tải, trình duyệt sẽ thực thi file JavaScript (main.js) được liên kết bằng thẻ:
...
>   - `number` là: lưu kiểu số
>   - `string` là: lưu kiểu chuỗi kí tự
>   - `boolean` là: lưu kiểu đúng hoặc sai logic
...
Xin chào, mình là Mai Tuan Duc, năm nay mình 20 tuổi. 
> - Nếu em quên dấu `;` hoặc quên dấu `+`, điều gì xảy ra? Trình duyệt báo lỗi thế nào?
Nếu quên dấu ; thì java vẫn chạy được còn quên đấu + thì nó sẽ tbao lỗi:
...
> - Điều thú vị nhất em vừa khám phá được về console là gì?
 ...
 #### Console cho phép chạy JavaScript trực tiếp và xem kết quả ngay lập tức mà không cần sửa file HTML.Nó rất hữu ích để kiểm tra biến, chạy thử hàm và tìm lỗi trong chương trình.
> - Em gặp lỗi cú pháp nào? Em đã xử lý bằng cách nào (tự sửa, hỏi bạn, đọc lỗi, tìm Google, …)?
Em gặp lỗi thiếu dấu + khi nối chuỗi. Console báo SyntaxError.
Em đọc thông báo lỗi, sau đó sửa lại code và reload trang.
...
> b) Nếu `score = 6`, em dự đoán console sẽ in: Trùn bình
...
Như kiểu khi ta chọn đi bên phải thì chắc chắn sẽ ta sẽ không đi bên trái ta chọn tiếp tục đi thẳng thì sẽ không ngoái đầu nhìn lại=))
...
>   - Tên hàm: tên dùng để gọi hàm, ví dụ tinhDiemTrungBinh...................
>   - Tham số (parameters): các giá trị đầu vào của hàm, ví dụ m1, m2, m3
>   - Thân hàm (body): phần code bên trong { } để thực hiện xử lý
>   - Giá trị trả về (return): phần code bên trong { } để thực hiện xử lý
> - Ưu điểm của việc dùng hàm thay vì lặp lại cùng một đoạn code nhiều lần là gì?
Giúp tái sử dụng code nhiều lần.

Làm chương trình ngắn gọn và dễ đọc hơn.

Dễ sửa lỗi và bảo trì vì chỉ cần sửa trong hàm.

Giúp chia chương trình thành các phần nhỏ dễ quản lý.
---
...
Em hơi khó hiểu cách hàm nhận tham số và trả về giá trị bằng return
> - Em đã làm gì để vượt qua (thử nhiều lần, hỏi bạn, xem lại ví dụ, tra Google, …)?

Em đọc lỗi trong Console và xem lại ví dụ trong bài để hiểu cách hoạt động của if/else.
...
Lệnh này dùng để tìm phần tử HTML có id là status trong trang web để JavaScript có thể thao tác với nó.
...
khi nhấn nút btnHello, nội dung của đoạn <p id="status"> sẽ được thay đổi thành:
...
"input": xảy ra khi người dùng nhập hoặc thay đổi nội dung trong ô input.
...
DOM là cấu trúc của trang web mà JavaScript có thể thao tác, ví dụ thay đổi chữ, màu nền hoặc thêm nội dung mới.
>   ................................................................
